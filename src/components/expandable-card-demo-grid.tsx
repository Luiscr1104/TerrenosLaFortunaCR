...
const cards = [
  ...
  {
    description: "Chachagua, San Carlos",
    title: "Tropical Retreat Land",
    src: "/images/CasaSofia/7.jpeg",
    ctaText: "View Property",
    ctaLink: "/properties/tropical-retreat-land",
    content: () => {
      return (
        <p>
  ...
  {
    description: "El Tanque, La Fortuna",
    title: "Residential Lot – Gated Community",
    src: "/images/CasaSofia/8.jpeg",
    ctaText: "View Property",
    ctaLink: "/properties/residential-lot-tanque",
    content: () => {
      return (
        <p>
